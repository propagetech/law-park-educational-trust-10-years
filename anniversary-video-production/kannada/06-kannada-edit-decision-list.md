...
- **Protect faces.** No aggressive sharpening, no AI face enhancement, no skin smoothing. `05` section 3.1 forbids AI-upscaling documentary photographs of real children and presenting the result as archival record. Every enlargement in this cut is a plain LANCZOS resample and nothing more.
- Sub-HD material sits inside a cream or navy card at native size rather than being blown up. Eight shots use that treatment.
