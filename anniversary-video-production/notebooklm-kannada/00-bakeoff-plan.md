...
**Incumbent.** `anniversary-video-production/kannada/kannada-1080p-EVENT-master.mp4`
...
Target folder: `anniversary-video-production/notebooklm-kannada/upload/`
...
- Save to `anniversary-video-production/notebooklm-kannada/nblm-kannada-v1.mp4`.
...
`anniversary-video-production/notebooklm-kannada/01-comparison.md`.
...
```
anniversary-video-production/notebooklm-kannada/
