...
|---|---|---|---|
| [data/stats.ts](../data/stats.ts) and [public/magazine/template-06.html](../public/magazine/template-06.html) | 1000+ | villages / districts | 150+ / 10+ |
| [components/sections/Hero.tsx](../components/sections/Hero.tsx) | 500+ | districts | 5+, "Across Karnataka" |
| [CLIENT_FEEDBACK_STATUS.md](../CLIENT_FEEDBACK_STATUS.md) | 500+ | schools | 150+ |
| [PROJECT_SUMMARY.md](../PROJECT_SUMMARY.md) | 550+ | locations | 8+ |
...
- [app/layout.tsx](../app/layout.tsx) schema.org: `foundingDate: '2016'`
- Magazine: "Since 2016, we have been travelling to rural areas"
- [components/pages/DonorInviteContentPage.tsx](../components/pages/DonorInviteContentPage.tsx), the founder's own donor letter: *"Along with my husband Mr. Manjunatha S. M we started this Trust in **2012** (registered **2016**)."*
...
| Year | [data/milestones.ts](../data/milestones.ts) | Magazine |
|---|---|---|
...
`partnerNGOs` in [data/websiteContent.ts](../data/websiteContent.ts) lists:
