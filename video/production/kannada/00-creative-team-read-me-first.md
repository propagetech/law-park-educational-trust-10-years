...
- **The facts are settled and sourced.** [`01-source-of-truth.md`](../../research/01-source-of-truth.md)
  and [`02-evidence-table.csv`](../../research/02-evidence-table.csv)
...
- **The brief holds even if the cut does not.** [`07-bilingual-creative-brief.md`](../../research/07-bilingual-creative-brief.md)
  carries tone, typography and the words that are never used.
- **Consent decides what you may show.** [`04-media-inventory.csv`](../../research/04-media-inventory.csv)
