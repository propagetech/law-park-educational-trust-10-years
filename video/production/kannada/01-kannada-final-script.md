...
Every line is **Version A of [`09-kannada-five-minute-script.md`](../../research/09-kannada-five-minute-script.md), verbatim**, with two documented departures listed in section 2. Nothing has been rewritten, shortened or paraphrased to fit picture.
...
Claim IDs resolve in [`02-evidence-table.csv`](../../research/02-evidence-table.csv). Every claim below is **VERIFIED** unless marked otherwise.
