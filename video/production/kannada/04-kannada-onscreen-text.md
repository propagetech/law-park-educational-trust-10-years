...
Nothing here is a translation of the English cut. The wording is fixed by [`12-bilingual-onscreen-text-and-lower-thirds.md`](../../research/12-bilingual-onscreen-text-and-lower-thirds.md); this document turns it into a buildable spec and adds the four strings the Kannada cut needs that the English cut does not.
...
**Hard rules, all from [`07`](../../research/07-bilingual-creative-brief.md) section 9 and [`14`](../../research/14-rights-consent-and-publishing-checklist.md) Part 7.**
