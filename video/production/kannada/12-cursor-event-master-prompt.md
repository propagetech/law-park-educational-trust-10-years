...
video/production/kannada/ in this repository. Read before you act:
tools/README.md, 06-kannada-edit-decision-list.md section 7,
07-final-rights-and-approval-checklist.md, and
../research/14-rights-consent-and-publishing-checklist.md.
...
Name the output:
  video/production/kannada/kannada-1080p-EVENT-master.mp4
...
Write video/production/kannada/13-event-playback-notes.md with:
