...
| | |
|---|---|
| **Primary** | `video/production/kannada/kannada-1080p-EVENT-master.mp4` |
...
Generated with `video/production/kannada-voice`, not `tts_eleven.py`.
...
licence. See `video/production/kannada-voice/reports/final-voice-recommendation.md`.
